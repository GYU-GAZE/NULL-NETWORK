...
func _open_system_menu() -> void:
	...
	_system_menu_tween.tween_property(
		system_menu_panel, "scale:y", 1.0, system_menu_open_seconds
	)
	_system_menu_tween.parallel().tween_property(
		system_menu_panel, "modulate:a", 1.0, system_menu_open_seconds * 0.75
	)
...
func _close_system_menu(animated: bool = true) -> void:
	...
	_system_menu_tween.tween_property(
		system_menu_panel, "scale:y", 0.04, system_menu_close_seconds
	)
	_system_menu_tween.parallel().tween_property(
		system_menu_panel, "modulate:a", 0.0, system_menu_close_seconds * 0.8
	)
