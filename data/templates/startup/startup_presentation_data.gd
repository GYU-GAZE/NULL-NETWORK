...
@export_range(0.01, 8.0, 0.01) var reveal_seconds: float = 1.44
...
@export_range(0.0, 0.9, 0.01) var null_logo_build_pan_start_ratio: float = 0.34
...
@export_range(0.0, 0.5, 0.01) var null_logo_idle_glitch_alpha: float = 0.12
